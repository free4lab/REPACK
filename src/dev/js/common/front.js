...
;(function() {
    ...
    $('[data-gen="nav-pro"]').each(function () {
        ...
        // 等待其他更新完毕后删除
        if ($cur.is('img')) {
            $cur.attr('src', AppUrl.newfront + 'img/fwapp-toggle.png')
        } else {
            $cur.parent().addClass('area-avatar')
            $cur.replaceWith('<img class="nav-avatar nav-app" src="' + AppUrl.newfront + 'img/fwapp-toggle.png" data-gen="nav-pro" data-toggle="front-popover-bottom" data-target="' + $cur.data('target') + '">')
        }
        ...
        [
            ...
            '><a href="', AppUrl.account,'" target="_blank"><img src="', AppUrl.newfront, 'img/brand-account.png" alt="account"/></a></li>',
